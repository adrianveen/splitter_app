...
pyinstaller --onefile --noconsole --icon="%ABS_ICON_FILE%" --distpath "%DIST_DIR%" --workpath "%BUILD_DIR%" --add-data "resources/images/wallet-icon.ico;resources/images" "%PYTHON_FILE%"
if %errorlevel% neq 0 (
