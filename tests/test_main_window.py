...
from PySide6.QtWidgets import QApplication, QHeaderView, QMessageBox, QTableWidgetItem
...
def test_on_split_changed_updates_ower_label(app) -> None:
    """Test _on_split_changed updates ower label."""
